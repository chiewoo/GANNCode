...
parser.add_option("-y","--increase-factor",action="store",type="float",default=1.001,help="rprop increase factor. original devault value of FANN library is 1.2")
...
parser.add_option("-g","--steep-out",action="store",type="float",default=0.9,help="steepness of output layer activation function. original default value of FANN library is 0.5")
